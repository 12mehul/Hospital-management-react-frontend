  ...
  return (
    <>
      ...
      <div className="relative flex-grow mb-5">
        ...
        <input
          type="text"
          className="w-full pl-10 pr-4 py-2 p-3 text-lg text-gray-700 font-normal border-2 border-cyan-100 border-b-cyan-300 focus:border-cyan-500 focus:outline-none hover:shadow-md bg-transparent rounded-md"
          placeholder="Search Doctors and Patients..."
        />
      </div>
                  ...
                  <tr className="bg-white transition-all duration-500 hover:bg-gray-100">
                    ...
                    <td className="p-5 flex items-center gap-1">
                      ...
                      <button className="p-2 cursor-pointer rounded-full bg-white group transition-all duration-500 flex item-center hover:bg-rose-600">
                        ...
                        >
                          <path
                            className="fill-rose-600 group-hover:fill-white"
